...
export const BaseExecutionNode = memo(
    ({ id, icon: Icon, name, description,status="initial", children, onDoubelClick, onSetting }: BaseExecutionNodeProps) => {
        ...
        return (
            <WorkflowNode name={name} description={description} onDelete={handelDelete} onSettings={onSetting}>
                ...
                <BaseNode status={status} onDoubleClick={onDoubelClick}>
                    <BaseNodeContent>
                        {typeof Icon === "string" ? (
