...
import { useSuspanseExecution } from "../hooks/use-executions"
...
export const ExecutionView = ({ executionId }: { executionId: string }) => {
    const { data: execution } = useSuspanseExecution(executionId)
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm">{execution.inggestEventId}</p>
                    </div>
                </div>
                {execution.error ? (
